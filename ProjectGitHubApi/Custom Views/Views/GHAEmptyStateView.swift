//
//  GHAEmptyStateView.swift
//  ProjectGitHubApi
//
//  Created by Ana Caroline de Souza on 02/05/20.
//  Copyright © 2020 Leo Corp. All rights reserved.
//

import UIKit

class GHAEmptyStateView: UIView {
    
    let messageLabel = GHATitleLable(textAlignment: .center, fontSize: 28)
